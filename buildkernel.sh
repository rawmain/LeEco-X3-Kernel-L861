...
export PATH=/home/wks/lineage/prebuilts/gcc/linux-x86/aarch64/aarch64-linux-android-4.9/bin:$PATH
...
rm ./.config;
nice make -w V=0 MTK_TARGET_PROJECT=x500 TARGET_BUILD_VARIANT=user $1 2> ./build_errors_warnings.log;
